...
using use = useUsing("use")`,
  ...
  [SkillNames.PYTHON]: {
    ...
    name: "python",
    label: "Python",
    shortDescription: "The snake that makes coding actually fun! 🐍✨",
    color: "#3776ab",
  ...
  [SkillNames.C]: {
    ...
    name: "c",
    label: "C",
    shortDescription: "Low-level gang, pointers go brrrr! 🔧💪",
    color: "#a8b9cc",
  ...
  [SkillNames.CSHARP]: {
    ...
    name: "csharp",
    label: "C#",
    shortDescription: "C but make it fancy with classes everywhere! 🎮🎵",
    color: "#239120",
  ...
  [SkillNames.RUST]: {
    ...
    name: "rust",
    label: "Rust",
    shortDescription: "Memory safety goes crazy, the borrow checker owns you! 🦀🔒",
    color: "#dea584",
...
export const EXPERIENCE: Experience[] = [
  {
    ...
    startDate: "2023",
    endDate: "Present",
    title: "High School Student & Self-Taught Developer",
    company: "Learning Journey",
    description: [
      "Self-taught web development with Next.js and React, building real projects like Hativon.",
      "Learning Python, C, and C# through school curriculum and personal exploration.",
      "Contributed to Zed editor (open source) - merged PR for extensions UI improvements.",
      "Daily Neovim user, customizing my dev environment with a modern 0.11+ config.",
    ],
    skills: [
      SkillNames.NEXTJS,
      SkillNames.TS,
  ...
  },
  {
    ...
    company: "Zed Editor",
    description: [
      "Contributed to Zed, a high-performance code editor built in Rust.",
      "Implemented upsell banners for integrated extensions in the extensions UI.",
      "Learned Rust through contributing to a real-world codebase.",
      "Gained experience with large-scale open source collaboration workflows.",
    ],
    skills: [
      SkillNames.RUST,
      SkillNames.GIT,
